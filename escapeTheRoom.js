...
// RoomObject(name, description, items, neededItems, actions) 
var treasurechest = new RoomObject('treasurechest', 'holds the key',
['codeLock'],'code', ['open'] )
var closet = new RoomObject('closet','find a clue', ['closetDoor', 
'doorKnob', 'message on the wall'], [], ['open'/* the door', 'take the message'*/])
var arr = [treasurechest, closet]


// Create an array of Room objects
var obj = new Room (arr[0])
var obj2 = new Room (arr[1])
var newArray = [obj,obj2]
// Create a new Game
//This parameter is room[], so needs the room array
//var gameObj = newArray.map(function(newArray){
    //return objects.item
    var newGame = new Game(newArray[0])
    //var newGame1 = new Game(newArray[1])
//})
// Create a new Player

var player = new Player(newArray[0])
